...
bool ModeTitle::Render() {
	...
	DrawGraph(120, 860, _cg["off_credit"], TRUE);
	DrawGraph(435, 955, _cg["off_end"], TRUE);
	...
	if (_menuPos == 4) { DrawGraph(120, 860, _cg["on_credit"],   TRUE); }
	if (_menuPos == 5) { DrawGraph(435, 955, _cg["on_end"],      TRUE); }
