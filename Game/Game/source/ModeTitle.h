...
protected:
	...
	static constexpr int ALL_MENU_NUM = 10;  // メニューUI画像総数
	static constexpr int MENU_NUM = 5;       // メニューUI画像数(ON,OFF別)
	...
	static constexpr int MENU_POS_X[MENU_NUM] = { 120,435,120,435,120 }; // メニューUI画像のX座標
	static constexpr int MENU_POS_Y[MENU_NUM] = { 480,575,670,765,860 }; // メニューUI画像のY座標
